This would be an alfred workflow to switch magic accessories based on email/shared file (very inefficient) but im out of options due to the nature of connectivity allowed on all my devices.
